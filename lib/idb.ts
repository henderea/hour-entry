...
// v1 - NOTE
dbUpgrades.add((database: IDBPDatabase<any>, _oldVersion: number, _newVersion: number | null, _transaction: UpgradeTransaction<any>) => database.createObjectStore('config', { autoIncrement: true }));
